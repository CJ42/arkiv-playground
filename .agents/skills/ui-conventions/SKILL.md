---
name: ui-conventions
description: Frontend change conventions for apps/web — dark mode (the highest-frequency rework source), theming inline SVG/chart colors, loading/empty/error states. Use for any UI change.
---
