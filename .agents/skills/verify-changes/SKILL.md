---
name: verify-changes
description: Verify a code change in this repo before committing or opening a PR. Use after editing the source code — picks the minimal sufficient check set per touched area.
---
